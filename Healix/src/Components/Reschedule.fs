module Healix.Components.Reschedule
...
let private classes : CssModules.Components.Reschedule = import "default" "./Reschedule.module.scss"
                    ...
                    Html.form [
                        ...
                        prop.children [
                            Html.label [
                                ...
                                Html.span "I have a schedule conflict"
                            ]
                            Html.label [
                                Html.input [
                                    prop.type' "radio"
                            ...
                            Html.label [
                                ...
                                Html.span "Something more important came up"
                            ]
                            Html.label [
                                Html.input [
                                    prop.type' "radio"
